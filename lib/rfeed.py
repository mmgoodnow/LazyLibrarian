...
class Serializable:
    ...
    def _date(date):
        ...
        # Alright, I admit it: this method looks hideous.
        # The thing is that RFC 822 requires a specific format for dates, and strftime is
        # locale dependent, so I can't use it to create the final date unless I force change the system locale.
        #
        # I looked into that (locale.setlocale, then restore), but I got the feeling that I was doing things
        # that I was going to regret later.
        ...
        return "%s, %02d %s %04d %02d:%02d:%02d GMT" % (["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]
                                                        [date.weekday()], date.day,
                                                        ["Jan", "Feb", "Mar", "Apr", "May", "Jun",
                                                         "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
                                                        [date.month-1], date.year, date.hour, date.minute, date.second)
...
class Image(Serializable):
    ...
    def __init__(self, url, title, link, width=None, height=None, description=None):
        ...
        description -- Optional. Contains text that is included in the TITLE attribute of the link formed
...
class iTunes(Extension):
    ...
    def __init__(self, author=None, block=None, categories=None, image=None, explicit=None, complete=None, owner=None,
                 subtitle=None, summary=None, new_feed_url=None, type=None):
        """ Keyword arguments:
...
class iTunesItem(Serializable):
    ...
    def __init__(self, author=None, block=None, image=None, duration=None, explicit=None, is_closed_captioned=None,
                 order=None, subtitle=None, summary=None, title=None, episode=None, episodeType=None, season=None):
        """ Keyword arguments:
        ...
        self.explicit = True if (isinstance(explicit, basestring) and explicit.lower() == 'yes') else explicit
        self.is_closed_captioned = True if (isinstance(is_closed_captioned, basestring) and
                                            is_closed_captioned.lower() == 'yes') else is_closed_captioned
        self.order = order
        self.subtitle = subtitle
        self.summary = summary
        self.title = title
...
class Feed(Host):
    def __init__(self, title, link, description, language=None, copyright=None, managingEditor=None, webMaster=None,
                 pubDate=None, lastBuildDate=None, categories=None, generator=None, docs=None, cloud=None,
                 ttl=None, image=None, rating=None, textInput=None, skipHours=None, skipDays=None, items=None,
                 extensions=None):
        """ Keyword arguments:
