...
BASE_DEFAULTS: List[ConfigItem] = [
    ...
    ConfigDownloadTypes('WWT', 'WWT_DLTYPES', 'A,E,M'),
...
ARRAY_DEFS: Dict[str, List[ConfigItem]] = {
    ...
    ConfigDownloadTypes('Newznab%i', "DLTYPES", 'A,E,M'),
    ],
    'TORZNAB': [
    ...
    ConfigDownloadTypes('Torznab%i', "DLTYPES", 'A,E,M'),
    ...
    ConfigDownloadTypes('RSS_%i', "DLTYPES", 'E'),
    ...
    ConfigDownloadTypes('IRC_%i', "DLTYPES", 'E'),
    ],
    'GEN_': [
    ...
    ConfigDownloadTypes('GEN_%i', "DLTYPES", 'E'),
    ],
    'APPRISE_': [
