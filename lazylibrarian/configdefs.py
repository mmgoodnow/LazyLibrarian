...
BASE_DEFAULTS: List[ConfigItem] = [
    ...
    ConfigCSV('General', 'MAG_NOUNS', "winter, spring, summer, fall, autumn, christmas, edition, special", force_lower=True),
    ...
    ConfigCSV('General', 'REJECT_MAGS', '', force_lower=True),
    ...
    ConfigCSV('General', 'REJECT_COMIC', 'epub, mobi', force_lower=True),
