...
BASE_DEFAULTS: List[ConfigItem] = [
    ...
    ConfigInt('General', 'HTTP_PORT', 5299),
    ConfigStr('General', 'HTTP_HOST', '0.0.0.0'),
    ConfigStr('General', 'HTTP_USER', ''),
    ConfigStr('General', 'HTTP_PASS', ''),
    ConfigBool('General', 'HTTP_PROXY', 0),
    ConfigStr('General', 'HTTP_ROOT', ''),
    ConfigStr('General', 'HTTP_LOOK', 'bookstrap'),
    ConfigBool('General', 'HTTPS_ENABLED', 0),
    ConfigStr('General', 'HTTPS_CERT', ''),
    ConfigStr('General', 'HTTPS_KEY', ''),
    ...
    ConfigBool('General', 'MAG_IMG', 1),
    ConfigBool('General', 'COMIC_IMG', 1),
    ConfigBool('General', 'SERIES_TAB', 1),
    ConfigBool('General', 'MAG_TAB', 1),
    ConfigBool('General', 'COMIC_TAB', 0),
    ...
    ConfigBool('General', 'API_ENABLED', 0),
    ConfigStr('General', 'API_KEY', ''),
    ConfigStr('General', 'PROXY_HOST', ''),
    ConfigStr('General', 'PROXY_TYPE', ''),
    ConfigStr('General', 'PROXY_LOCAL', ''),
    ConfigCSV('General', 'NAME_POSTFIX', 'snr, jnr, jr, sr, phd'),
    ConfigCSV('General', 'NAME_DEFINITE', 'the, a'),
    ConfigCSV('General', 'SKIPPED_EXT', 'fail, part, bts, !ut, torrent, magnet, nzb, unpack'),
    ConfigCSV('General', 'BANNED_EXT', 'avi, mp4, mov, iso, m4v'),
    ...
    ConfigCSV('General', 'ISSUE_NOUNS', 'issue, iss, no, nr, #, n'),
    ConfigCSV('General', 'VOLUME_NOUNS', "vol, volume"),
    ConfigCSV('General', 'MAG_NOUNS', "winter, spring, summer, fall, autumn, christmas, edition, special"),
    ConfigStr('General', 'IMP_MONTHLANG', ''),
    ConfigStr('General', 'IMP_AUTOADD', ''),
    ConfigBool('General', 'IMP_AUTOADD_COPY', 1),
    ConfigBool('General', 'IMP_AUTOADD_BOOKONLY', 0),
    ConfigStr('General', 'IMP_AUTOADDMAG', ''),
    ConfigBool('General', 'IMP_AUTOADDMAG_COPY', 1),
    ConfigBool('General', 'IMP_AUTOADD_MAGONLY', 0),
    ConfigBool('General', 'IMP_AUTOSEARCH', 0),
    ConfigStr('General', 'IMP_CALIBREDB', ''),
    ConfigBool('General', 'IMP_CALIBRE_EBOOK', 0),
    ConfigBool('General', 'IMP_CALIBRE_COMIC', 0),
    ConfigBool('General', 'IMP_CALIBRE_MAGAZINE', 0),
    ConfigBool('General', 'IMP_CALIBRE_MAGTITLE', 1),
    ConfigBool('General', 'IMP_CALIBRE_MAGISSUE', 0),
    ConfigBool('General', 'BLACKLIST_FAILED', 1),
    ConfigBool('General', 'BLACKLIST_PROCESSED', 0),
    ConfigBool('General', 'CALIBRE_USE_SERVER', 0),
    ConfigStr('General', 'CALIBRE_SERVER', ''),
    ConfigStr('General', 'CALIBRE_USER', ''),
    ConfigStr('General', 'CALIBRE_PASS', ''),
    ConfigBool('General', 'CALIBRE_RENAME', 0),
    ConfigBool('General', 'IMP_SINGLEBOOK', 0),
    ConfigBool('General', 'IMP_RENAME', 0),
    ConfigBool('General', 'MAG_RENAME', 0),
    ConfigBool('General', 'IMP_MAGOPF', 1),
    ...
    ConfigInt('NZBGet', 'NZBGET_PORT', 0),
    ...
    ConfigInt('UTORRENT', 'UTORRENT_PORT', 0),
    ...
    ConfigInt('QBITTORRENT', 'QBITTORRENT_PORT', 0),
    ...
    ConfigInt('TRANSMISSION', 'TRANSMISSION_PORT', 0),
    ...
    ConfigInt('DELUGE', 'DELUGE_PORT', 0),
    ...
    ConfigInt('SYNOLOGY', 'SYNOLOGY_PORT', 0),
    ...
    ConfigStr('KAT', 'KAT_DLTYPES', 'A,E,M'),
    ConfigInt('KAT', 'KAT_SEEDERS', 0),
    ConfigStr('WWT', 'WWT_HOST', 'https://worldwidetorrents.me'),
    ConfigBool('WWT', 'WWT', 0),
    ConfigInt('WWT', 'WWT_DLPRIORITY', 0),
    ConfigStr('WWT', 'WWT_DLTYPES', 'A,E,M'),
    ConfigInt('WWT', 'WWT_SEEDERS', 0),
    ConfigStr('TPB', 'TPB_HOST', 'https://pirateproxy.cc'),
    ConfigBool('TPB', 'TPB', 0),
    ConfigInt('TPB', 'TPB_DLPRIORITY', 0),
    ConfigStr('TPB', 'TPB_DLTYPES', 'A,C,E,M'),
    ConfigInt('TPB', 'TPB_SEEDERS', 0),
    ConfigStr('ZOO', 'ZOO_HOST', 'https://zooqle.com'),
    ConfigBool('ZOO', 'ZOO', 0),
    ConfigInt('ZOO', 'ZOO_DLPRIORITY', 0),
    ConfigStr('ZOO', 'ZOO_DLTYPES', 'A,E,M'),
    ConfigInt('ZOO', 'ZOO_SEEDERS', 0),
    ConfigStr('Torrof', 'TRF_HOST', 'torrof.com'),
    ConfigBool('Torrof', 'TRF', 0),
    ConfigInt('Torrof', 'TRF_DLPRIORITY', 0),
    ConfigStr('Torrof', 'TRF_DLTYPES', 'A,E,M'),
    ConfigInt('TRF', 'TRF_SEEDERS', 0),
    ConfigStr('TDL', 'TDL_HOST', 'torrentdownloads.me'),
    ConfigBool('TDL', 'TDL', 0),
    ConfigInt('TDL', 'TDL_DLPRIORITY', 0),
    ConfigStr('TDL', 'TDL_DLTYPES', 'A,E,M'),
    ConfigInt('TDL', 'TDL_SEEDERS', 0),
    ConfigStr('BOK', 'BOK_HOST', 'b-ok.cc'),
    ConfigStr('BOK', 'BOK_LOGIN', "https://singlelogin.me/rpc.php"),
    ...
    ConfigStr('BOK', 'BOK_DLTYPES', 'E'),
    ConfigStr('BFI', 'BFI_HOST', 'en.bookfi.net'),
    ConfigBool('BFI', 'BFI', 0),
    ConfigInt('BFI', 'BFI_DLPRIORITY', 0),
    ConfigStr('BFI', 'BFI_DLTYPES', 'E'),
    ConfigStr('LIME', 'LIME_HOST', 'https://www.limetorrents.cc'),
    ConfigBool('LIME', 'LIME', 0),
    ConfigInt('LIME', 'LIME_DLPRIORITY', 0),
    ConfigStr('LIME', 'LIME_DLTYPES', 'A,E,M'),
    ConfigInt('LIME', 'LIME_SEEDERS', 0),
    ConfigStr('Newzbin', 'NEWZBIN_UID', ''),
    ConfigStr('Newzbin', 'NEWZBIN_PASS', ''),
    ConfigBool('Newzbin', 'NEWZBIN', 0),
    ConfigStr('General', 'EBOOK_TYPE', 'epub, mobi, pdf'),
    ConfigStr('General', 'AUDIOBOOK_TYPE', 'mp3, m4b'),
    ConfigStr('General', 'MAG_TYPE', 'pdf'),
    ConfigStr('General', 'REJECT_PUBLISHER', ''),
    ConfigStr('General', 'REJECT_WORDS', 'audiobook, mp3'),
    ConfigStr('General', 'REJECT_AUDIO', 'epub, mobi'),
    ConfigStr('General', 'REJECT_MAGS', ''),
    ConfigInt('General', 'REJECT_MAXSIZE', 0),
    ConfigInt('General', 'REJECT_MINSIZE', 0),
    ConfigInt('General', 'REJECT_MAXAUDIO', 0),
    ConfigInt('General', 'REJECT_MINAUDIO', 0),
    ConfigInt('General', 'REJECT_MAGSIZE', 0),
    ConfigInt('General', 'REJECT_MAGMIN', 0),
    ConfigStr('General', 'REJECT_COMIC', 'epub, mobi'),
    ...
    ConfigStr('General', 'COMIC_TYPE', 'cbr, cbz'),
    ...
    ConfigInt('Email', 'EMAIL_SMTP_PORT', 25),
    ...
    ConfigStr('Email', 'EMAIL_CONVERT_FROM', ''),
    ConfigStr('Email', 'EMAIL_SEND_TYPE', ''),
...
ARRAY_DEFS: Dict[str, List[ConfigItem]] = {
    'NEWZNAB': [
    ConfigStr('Newznab%i', 'NAME', 'Newznab'),
    ConfigStr('Newznab%i', "DISPNAME", ''),
    ConfigBool('Newznab%i', "ENABLED", False),
    ConfigStr('Newznab%i', "HOST", ''),
    ConfigStr('Newznab%i', "API", ''),
    ConfigStr('Newznab%i', "GENERALSEARCH", ''),
    ConfigStr('Newznab%i', "BOOKSEARCH", ''),
    ConfigStr('Newznab%i', "MAGSEARCH", ''),
    ConfigStr('Newznab%i', "AUDIOSEARCH", ''),
    ConfigStr('Newznab%i', "COMICSEARCH", ''),
    ConfigCSV('Newznab%i', "BOOKCAT", '7000,7020'),
    ConfigCSV('Newznab%i', "MAGCAT", '7010'),
    ConfigCSV('Newznab%i', "AUDIOCAT", '3030'),
    ConfigCSV('Newznab%i', "COMICCAT", '7030'),
    ConfigInt('Newznab%i', "EXTENDED", 1),
    ConfigStr('Newznab%i', "UPDATED", ''),
    ConfigBool('Newznab%i', "MANUAL", False),
    ConfigInt('Newznab%i', "APILIMIT", 0),
    ConfigInt('Newznab%i', "APICOUNT", 0),
    ConfigInt('Newznab%i', "RATELIMIT", 0),
    ConfigInt('Newznab%i', "DLPRIORITY", 0),
    ConfigCSV('Newznab%i', "DLTYPES", 'A,E,M'),
    ],
    'TORZNAB': [
    ConfigStr('Torznab%i', 'NAME', 'Torznab'),
    ConfigStr('Torznab%i', "DISPNAME", ''),
    ConfigBool('Torznab%i', "ENABLED", False),
    ConfigStr('Torznab%i', "HOST", ''),
    ConfigStr('Torznab%i', "API", ''),
    ConfigStr('Torznab%i', "GENERALSEARCH", ''),
    ConfigStr('Torznab%i', "BOOKSEARCH", ''),
    ConfigStr('Torznab%i', "MAGSEARCH", ''),
    ConfigStr('Torznab%i', "AUDIOSEARCH", ''),
    ConfigStr('Torznab%i', "COMICSEARCH", ''),
    ConfigCSV('Torznab%i', "BOOKCAT", '8000,8010'),
    ConfigCSV('Torznab%i', "MAGCAT", '8030'),
    ConfigCSV('Torznab%i', "AUDIOCAT", '3030'),
    ConfigCSV('Torznab%i', "COMICCAT", '8020'),
    ConfigInt('Torznab%i', "EXTENDED", 1),
    ConfigStr('Torznab%i', "UPDATED", ''),
    ConfigBool('Torznab%i', "MANUAL", False),
    ConfigInt('Torznab%i', "APILIMIT", 0),
    ConfigInt('Torznab%i', "APICOUNT", 0),
    ConfigInt('Torznab%i', "RATELIMIT", 0),
    ConfigInt('Torznab%i', "DLPRIORITY", 0),
    ConfigCSV('Torznab%i', "DLTYPES", 'A,E,M'),
    ConfigInt('Torznab%i', "SEEDERS", 0),
    ],
    'RSS_': [
    ConfigStr('RSS_%i', 'NAME', 'RSS'),
    ConfigStr('RSS_%i', "DISPNAME", ''),
    ConfigBool('RSS_%i', "ENABLED", False),
    ConfigStr('RSS_%i', "HOST", ''),
    ConfigInt('RSS_%i', "DLPRIORITY", 0),
    ConfigCSV('RSS_%i', "DLTYPES", 'E'),
    ConfigStr('RSS_%i', "LABEL",  ''),
    ],
    'IRC_': [
    ConfigStr('IRC_%i', 'NAME', 'IRC'),
    ConfigStr('IRC_%i', "DISPNAME", ''),
    ConfigBool('IRC_%i', "ENABLED", False),
    ConfigStr('IRC_%i', "SERVER", ''),
    ConfigStr('IRC_%i', "CHANNEL", ''),
    ConfigStr('IRC_%i', "BOTNICK", ''),
    ConfigStr('IRC_%i', "BOTPASS", ''),
    ConfigStr('IRC_%i', "SEARCH", '@search'),
    ConfigInt('IRC_%i', "DLPRIORITY", 0),
    ConfigCSV('IRC_%i', "DLTYPES", 'E'),
    ],
    'GEN_': [
    ConfigStr('GEN_%i', 'NAME', 'GEN'),
    ConfigStr('GEN_%i', "DISPNAME", ''),
    ConfigBool('GEN_%i', "ENABLED", False),
    ConfigStr('GEN_%i', "HOST", ''),
    ConfigStr('GEN_%i', "SEARCH", ''),
    ConfigInt('GEN_%i', "DLPRIORITY", 0),
    ConfigCSV('GEN_%i', "DLTYPES", 'E'),
    ],
    'APPRISE_': [
    ConfigStr('APPRISE_%i', 'NAME', 'APPRISE'),
