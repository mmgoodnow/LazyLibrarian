...
BASE_DEFAULTS: List[ConfigItem] = [
    ...
    ConfigScheduler('Telemetry', 'TELEMETRY_INTERVAL', 'telemetry_send', 6, TimeUnit.HOUR,
        'TELEMETRYSEND', 'lazylibrarian.telemetry.telemetry_send', 'Send telemetry', needs_provider=False, persist=True),
    ...
    ConfigScheduler('SearchScan', 'CLEAN_CACHE_INTERVAL', 'clean_cache', 8, TimeUnit.DAY,
        'CLEANCACHE', 'lazylibrarian.cache.clean_cache', 'Clean cache', False, persist=False), # Interval is not used
    ConfigScheduler('SearchScan', 'AUTHORUPDATE_INTERVAL', 'author_update', 1, TimeUnit.MIN,
        'AUTHORUPDATE', 'lazylibrarian.scheduling.author_update', 'Upload authors', False, persist=False), # Interval is not used
    ConfigScheduler('SearchScan', 'SERIESUPDATE_INTERVAL', 'series_update', 1, TimeUnit.MIN,
        'SERIESUPDATE', 'lazylibrarian.scheduling.series_update', 'Update series', False, persist=False), # Interval is not used
